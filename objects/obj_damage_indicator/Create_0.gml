...
root.anim.add(
    ...
    new Animation(id, "y", y + 8, y - 30, _second_duration).ease(ease_linear)
        .delay(_first_duration + .5)
        .tag(tag),
        
    new Animation(id, "xscale", xscale, .01, _second_duration).ease(ease_linear)
        .delay(_first_duration + .5)
        .tag(tag),
        
    new Animation(id, "alpha", alpha, 0, _second_duration).ease(ease_linear)
        .delay(_first_duration + .5)
        .tag(tag)
